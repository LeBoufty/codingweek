...
public class RemplirBDD {
    ...
    public void remplir() throws Exception
    {
        ...
        try {
            ...
            path = path.substring(5);
            API.getInstance().addOffre("Cherche eau","Je cherche de l'eau.\nJ'adore l'eau et il n'y en a plus.", 1, 2, "Service", ImageBlob.pathtToByte(path));
            ...
            path = path.substring(5);
            API.getInstance().addOffre("Service de lutins","Les lutins fabriquent vos cadeaux.", 10, 3, "Service", ImageBlob.pathtToByte(path));
